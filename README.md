...
**98 tests · 9 suites · 91.12% line coverage** (708/777 lines, measured by `cargo-tarpaulin`).
...
- 📝 **[Test matrix](docs/TEST-COVERAGE.md)** — hand-curated per-public-API × test-layer matrix showing design intent and gaps (markdown, GitHub-renders inline).
